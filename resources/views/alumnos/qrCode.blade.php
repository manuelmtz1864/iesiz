        ...
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh">
            <div class="text-center">
                <div class="visible-print text-center">
                    {{-- {!! QrCode::size(200)->generate(route('certificates.show', $alumno->id_hash)); !!} --}}
                    {!! QrCode::size(200)->generate('http:192.168.1.15/iesiz/public/certificates/verificacion/'. $alumno->id_hash); !!}
                    <br>
                    <br>
